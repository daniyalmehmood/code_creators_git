public class ArrayFront9 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ArrayFront9.arrayFront9(new int[]{9, 2, 3}));
        System.out.println(ArrayFront9.arrayFront9(new int[]{1, 9, 9}));
        System.out.println(ArrayFront9.arrayFront9(new int[]{}));
        System.out.println(ArrayFront9.arrayFront9(new int[]{3, 9, 2, 3, 3}));
